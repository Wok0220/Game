...
public class WaveManager {
    ...
    public void initCampaign(int levelIndex) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            int delay = (i == 0) ? 5000 : 10000;
            currentWaveSpawns.add(new GameConfig.ZombieSpawn("NormalZombie", row, delay));
            System.out.println("添加僵尸生成：行=" + row + "，延迟=" + delay);
        }

        this.spawnedInWave = 0;
        // 初始延迟设置为5000，第一只僵尸5秒后生成
        this.nextSpawnTimer = 5000;
        this.isBetweenWaves = false;
    }
    ...
    public void update(float deltaTime) {
        ...
        if (currentWaveSpawns != null && currentWaveSpawns.isEmpty() && spawnedInWave >= 5) {
            allWavesCompleted = true;
        }
    }
